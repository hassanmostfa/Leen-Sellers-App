...
const HomeServiceCard = ({ item, navigation }) => {
  const handleShow = () => {
    navigation.navigate('ShowHomeService', { item }); // Navigate to route with item data
  };
          ...
          onPress: async () => {
            try {
              ...
              const response = await fetch(
                `https://leen-app.com/public/api/seller/homeServices/destroy/${item.id}`,
                {
                  method: 'DELETE',
                  headers: {
