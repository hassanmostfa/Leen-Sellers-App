...
import { View, Text, TouchableOpacity, FlatList, ActivityIndicator, StyleSheet, StatusBar } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import AsyncStorage from '@react-native-async-storage/async-storage';
import StudioBookingCard from '../../components/bookings/StudioBookingCard';
  ...
  const fetchBookings = async (category) => {
    ...
    try {
      ...
      if (category === 'Accepted') {
        response = await fetch('https://leen-app.com/public/api/seller/studioBookings', { headers });
      } else if (category === 'Pending') {
        response = await fetch('https://leen-app.com/public/api/seller/studioBookings/newRequests', { headers });
      } else if (category === 'Rejected') {
        response = await fetch('https://leen-app.com/public/api/seller/studioBookings/rejectedRequests', { headers });
      }
      ...
      <View style={styles.bookingsContainer}>
        {loading ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => <StudioBookingCard navigation={navigation} item={item} />}
