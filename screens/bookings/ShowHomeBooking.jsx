...
const ShowHomeBooking = ({ route, navigation }) => {
  ...
  const additionalServicesTotal = calculateAdditionalServicesTotal(item.additionalHomeServiceBookingItems);
  const totalPrice = parseFloat(item.home_service.price) + additionalServicesTotal;
   ...
   const handleRejectBooking = async (id) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://leen-app.com/public/api/seller/homeBookings/reject/${item.id}`,
      ...
      Alert.alert('نجاح', 'تم رفض الحجز بنجاح' , [{ text: 'حسنا' , onPress: () => navigation.navigate('HomeBookings') }]);
    } catch (error) {
...
const handleAcceptBooking = async (id) => {
  ...
  try {
    ...
    const response = await axios.post(
      `https://leen-app.com/public/api/seller/homeBookings/accept/${id}`,
    ...
    setLoading(false);
    Alert.alert('نجاح', 'تم قبول الحجز بنجاح' , [{ text: 'حسنا' , onPress: () => navigation.navigate('HomeBookings') }]);
  } catch (error) {
    setLoading(false);
    Alert.alert(
      'خطأ',
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.cardContent}>
          <Text style={styles.cardTitle}>
            {item.home_service.name} ({item.home_service.price} ريال)
          </Text>
          ...
          <View style={styles.cardDetailContainer}>
            ...
            <View>
              ...
              {item.additionalHomeServiceBookingItems?.map((additionalItem) => (
          ...
          <View style={styles.cardDetailContainer}>
            ...
            <Text style={styles.cardDetail}>{item.home_service.discount ? item.home_service.percentage + '%' : 'لا يوجد خصم'}</Text>
          </View>
          ...
          <View>
            <Text style={styles.cardDetail}>العنوان</Text>
...
export default ShowHomeBooking;
