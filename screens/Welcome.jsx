...
const onboardingData = [
  {
    id: 1,
    title: 'لين | منصة مقدمات خدمات التجميل',
    image: require('../assets/images/leen logo2.png'), // Replace with your image
  ...
  {
    id: 2,
    title: 'أهلاً بك في منصة لين لمقدمي الخدمات!',
    description: 'انطلق الآن وابدأ بعرض خدماتك وتواصَل مع العملاء بسهولة واحترافية. ',
  ...
  {
    id: 3,
    title: 'إدارة حجوزاتك بكفاءة',
    description: 'استقبل الحجوزات، أكدها، وحدث حالتها بسهولة. تابع مواعيدك اليومية مع تقويم منظم.', 
  ...
  {
    id: 4,
    title: 'اعرض خدماتك وزد من أرباحك',
    description: 'أضف خدماتك، حدد أسعارك، وقدم عروضًا لجذب المزيد من العملاء وتحقيق النجاح.', 
